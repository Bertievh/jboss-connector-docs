...
The JBoss Connector allows OpCon to interact with JBoss Enterprise Application Platform (EAP) management beans (mbeans) and JMS queues from within an OpCon schedule.
